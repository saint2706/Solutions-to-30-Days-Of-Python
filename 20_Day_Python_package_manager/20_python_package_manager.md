...
We will see _get_, _status_code_,_headers_,_text_and_json_methods in_requests_ module:
...
3. Read the ~~[countries API](https://restcountries.eu/rest/v2/all)~~ (!!API IS DOWN!!) and find
