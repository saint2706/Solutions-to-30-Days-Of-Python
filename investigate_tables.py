...
def investigate_wiki_tables(url: str) -> Optional[List[pd.DataFrame]]:
    ...
    try:
        ...
        print("🌐 Error: Unable to connect to the website. Check your internet connection.")
        return None
...
def main() -> None:
    ...
    if tables:
        ...
        print("💡 Tip: These DataFrames can now be used for further analysis with pandas.")
    else:
