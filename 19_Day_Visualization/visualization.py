...
if not df.empty:
    ...
    print("Displaying Bar Chart: Total Revenue by Region. Please close the plot window to continue.")
    plt.show()
    ...
    print("Displaying Line Chart: Daily Revenue Trend. Please close the plot window to continue.")
    plt.show()


    # --- 3. Histogram: Distribution of Units Sold ---
    plt.figure(figsize=(10, 6))
    sns.histplot(df['Units Sold'], bins=10, kde=True) # kde adds a density curve
    plt.title('Distribution of Units Sold per Transaction', fontsize=16)
    plt.xlabel('Units Sold')
    plt.ylabel('Frequency')
    print("Displaying Histogram: Distribution of Units Sold. Please close the plot window to continue.")
    plt.show()
    ...
    print("Displaying Scatter Plot: Price vs. Units Sold. Please close the plot window to continue.")
    plt.show()
