...
def post() -> (
    Response
):  # pyright: ignore[reportReturnType] # changed from str to Response
    name = "Text Analyzer"
    if request.method == "GET":
        return render_template(
            "post.html", name=name, title=name
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("result"))  # pyright: ignore[reportReturnType]
