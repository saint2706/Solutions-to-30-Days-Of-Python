...
- [📘 Day 15](#-day-15)
  ...
  - [Example 1: SyntaxError](#example-1-syntaxerror)
    - [NameError](#nameerror)
  - [Example 1: NameError](#example-1-nameerror)
    - [IndexError](#indexerror)
  - [Example 1: IndexError](#example-1-indexerror)
    - [ModuleNotFoundError](#modulenotfounderror)
  - [Example 1: ModuleNotFoundError](#example-1-modulenotfounderror)
    - [AttributeError](#attributeerror)
  - [Example 1: AttributeError](#example-1-attributeerror)
    - [KeyError](#keyerror)
  - [Example 1: KeyError](#example-1-keyerror)
    - [TypeError](#typeerror)
